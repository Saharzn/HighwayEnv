...
class ControlledVehicle(Vehicle):
    ...
    def discrete_steering(self,action):
        ...
        if action[1]<0:
          ...
          self.target_lane_index[2] = ["0","1",0]
          s =  np.clip(self.steering_control(self.target_lane_index), -self.MAX_STEERING_ANGLE, self.MAX_STEERING_ANGLE)
            
        elif action[1]>=1 and action[1]<2:
          self.target_lane_index[2] = ["0","1",1]
          s =  np.clip(self.steering_control(self.target_lane_index), -self.MAX_STEERING_ANGLE, self.MAX_STEERING_ANGLE)
            
        elif action[1]>=2:
          self.target_lane_index[2] = ["0","1",2]
          s =  np.clip(self.steering_control(self.target_lane_index), -self.MAX_STEERING_ANGLE, self.MAX_STEERING_ANGLE)
        ...
        # elif action[1]>-0.5 and action[1]<0.5:
        #   s = 0
