...
class ControlledVehicle(Vehicle):
    ...
    if self.target_lane_index != self.lane_index:
        ...
        if abs(self.position[1] - self.road.network.graph[self.target_lane_index[0]][self.target_lane_index[1]][self.target_lane_index[2]].position[1]) < ALIGNMENT_THRESHOLD:
