...
from highway_env.envs.common.action import ActionType, DiscreteMetaAction
...
class EventHandler(object):
    ...
    @classmethod
    def handle_continuous_action_event(cls, action_type: DiscreteMetaAction, event: pygame.event.EventType) -> None:
